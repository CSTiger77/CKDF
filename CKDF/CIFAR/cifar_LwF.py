...
from CIFAR.alg_model.config.LwF_config import LwF_config
from CIFAR.alg_model.LwF import LwF
...
def parse_args():
    ...
    parser.add_argument('--model_name', type=str, default=LwF_config.model_name, help='cifar dataset path')
    parser.add_argument('--dataset_name', type=str, default=LwF_config.dataset_name, help='cifar dataset name')
    parser.add_argument('--dataset_path', type=str, default=LwF_config.dataset_root, help='cifar dataset path')
    ...
    parser.add_argument('--extracted_layers', type=list, default=LwF_config.extracted_layers,
    ...
    parser.add_argument('--checkpoints', type=str, default=LwF_config.checkpoint_path,
                        help='path for saving trained models')
    parser.add_argument('--print_interval', type=int, default=LwF_config.print_interval, help='print interval')
    parser.add_argument('--is_LwF_MC', type=int, default=LwF_config.is_LwF_MC, help='is_iCaRL')
    ...
    parser.add_argument('--NewData_to_oneclass', type=bool, default=LwF_config.NewData_to_oneclass,
                        help='NewData_to_oneclass')
    parser.add_argument('--val_current_task', type=bool, default=LwF_config.val_current_task,
                        help='NewData_to_oneclass')
...
def main():
    ...
    if args.is_LwF_MC < 2:
        ...
        EFAfIL_LwF_model = LwF(model_name=args.model_name, dataset_name=args.dataset_name,
                               ...
                               seed=args.seed)
        if args.is_LwF_MC == 2:
            EFAfIL_LwF_model.LwF_MC_feature_relearning_train_main(args)
        elif args.is_LwF_MC == 3:
            EFAfIL_LwF_model.LwF_MC_feature_relearning_train_main_balance(args)
        else:
            exit("err!")
