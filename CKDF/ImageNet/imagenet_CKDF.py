...
from ImageNet.alg_model.EFAfIL import EFAfIL
from ImageNet.alg_model.config.EFAfIL_config import EFAfIL_config
from ImageNet.alg_model.ILtFA import ILtFA
...
def parse_args():
    ...
    parser.add_argument('--MLP_name', type=str, default=EFAfIL_config.MLP_name, help='ImageNet dataset path')
    parser.add_argument('--discriminate_name', type=str, default=EFAfIL_config.discriminate_name,
                        help='discriminate_name')
    parser.add_argument('--dataset_name', type=str, default=EFAfIL_config.dataset_name, help='ImageNet dataset path')
    parser.add_argument('--dataset_path', type=str, default=EFAfIL_config.dataset_path, help='ImageNet dataset path')
    parser.add_argument('--dataset_json_path', type=str, default=EFAfIL_config.dataset_json_path,
                        help='ImageNet dataset_json_path')

    parser.add_argument('--num_classes', type=int, default=EFAfIL_config.num_classes, help='ImageNet dataset path')
    parser.add_argument('--img_size', type=int, default=EFAfIL_config.img_size, help='ImageNet dataset path')
    ...
    parser.add_argument('--discriminate_note_rate', type=float, default=EFAfIL_config.discriminate_note_rate,
    ...
    parser.add_argument('--MLP_KD_temp_2', type=float, default=EFAfIL_config.MLP_KD_temp_2, help='MLP distill temp for input')
    ...
    parser.add_argument('--FM_oversample', type=bool, default=EFAfIL_config.FM_oversample, help='FM_oversample')
    parser.add_argument('--use_feature_replay_in_new_model', type=bool,
                        default=EFAfIL_config.use_feature_replay_in_new_model, help='use_feature_replay_in_new_model')
