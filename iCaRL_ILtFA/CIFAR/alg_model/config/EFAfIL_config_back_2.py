...
globle_rate = 1
globle_is_iCaRL_LwF_BiC = 1  # 0 denotes EFAfIL_iCaRL; 1 denotes EFAfIL_LwF; 2 denotes EFAfIL_BiC
globle_task = 5
MLP_layers = 3
test_num = 7
...
if globle_is_iCaRL_LwF_BiC == 0:
    dir = "./cifar100EXP_resnet34_Sep/cifar10pretrain/EFAfIL_iCaRL/task{}/MLP{}/rate_{}/test{}".format(
        globle_task,
        MLP_layers,
        log_type,
        test_num)
elif globle_is_iCaRL_LwF_BiC == 1:
    dir = "./cifar100EXP_resnet34_Sep/cifar10pretrain/EFAfIL_LwF/task{}/MLP{}/rate_{}/test{}".format(globle_task,
                                                                                                          MLP_layers,
                                                                                                          log_type,
                                                                                                          test_num)
elif globle_is_iCaRL_LwF_BiC == 2:
    dir = "./cifar100EXP_resnet34_Sep/cifar10pretrain/EFAfIL_BiC/task{}/MLP{}/rate_{}/test{}".format(globle_task,
                                                                                                          MLP_layers,
                                                                                                          log_type,
                                                                                                          test_num)
