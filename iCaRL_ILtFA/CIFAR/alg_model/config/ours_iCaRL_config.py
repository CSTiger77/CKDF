...
if globle_is_iCaRL == 0:
    dir = "./cifar100EXP_resnet34_July/cifar10pretrain/_Test_iCaRL_ours/iCaRL_cmp/task{}/test{}/rate_{}".format(
        globle_task,
        test_num,
        log_type)
elif globle_is_iCaRL == 1:
    dir = "./cifar100EXP_resnet34_July/cifar10pretrain/_Test_iCaRL_ours/FC_iCaRL_cmp/task{}/MLP{}/test{}/rate_{}".format(
        globle_task,
        MLP_layers,
        test_num,
        log_type)
