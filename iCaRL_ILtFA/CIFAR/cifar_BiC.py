...
# os.chdir("/share/home/kcli/CL_research/EEIL_ILtFA")
# print(os.getcwd() )
# from CIFAR.alg_model.config.BiC_config import *
from CIFAR.alg_model.config.config import Config
from CIFAR.alg_model.config.BiC_config import BiC_config
from CIFAR.alg_model.BiC import BiC
...
def parse_args():
    ...
    parser.add_argument('--extracted_layers', type=list, default=BiC_config.extracted_layers,
    ...
    parser.add_argument('--train_method', type=int, default=BiC_config.train_method, help='bias_layer train_method')
    parser.add_argument('--oversample', type=bool, default=BiC_config.oversample, help='sampling strategy')
    parser.add_argument('--sample_seed', type=int, default=BiC_config.sample_seed, help='sample_seed')
