...
if "forCL_1" in imagenet100_json_path:
    dir = "./Imagenet100EXP/Imagenet100pretrain/iCaRL_DATAforCL_1/task20/rate_{}".format(log_type)
else:
    dir = "./Imagenet100EXP/Imagenet100pretrain/iCaRL_DATAforCL_2/task20/rate_{}".format(log_type)
